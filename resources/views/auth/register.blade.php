            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="door" class="col-md-4 col-form-label text-md-right">{{ __('Puerta') }}</label>

                            <div class="col-md-6">
                                <input id="door" type="text" class="form-control @error('door') is-invalid @enderror" name="door" value="{{ old('door') }}" required autocomplete="door" autofocus>
